...
pub const X86_SIZES: [(&str, Size); 9] = [
    ("BYTE", BYTE),
    ("WORD", WORD),
    ("DWORD", DWORD),
    ("AWORD", DWORD),
...
pub const X64_SIZES: [(&str, Size); 9] = [
    ("BYTE", BYTE),
    ("WORD", WORD),
    ("DWORD", DWORD),
    ("FWORD", FWORD),
...
pub const X64_REGISTERS: &[(&str, (RegId, Size))] = &[
    ("rax", (RAX, QWORD)),
    ("r0" , (RAX, QWORD)),
    ("rcx", (RCX, QWORD)),
    ("r1" , (RCX, QWORD)),
...
static X86_REGISTERS: &[(&str, (RegId, Size))] = &[
    ("eax", (RAX, DWORD)),
    ("ecx", (RCX, DWORD)),
    ("edx", (RDX, DWORD)),
    ("ebx", (RBX, DWORD)),
...
pub const X64_FAMILIES: &[(&str, (Size, RegFamily))] = &[
...
pub const X86_FAMILIES: &[(&str, (Size, RegFamily))] = &[
    ("Rb",(Size::BYTE,  RegFamily::LEGACY)),
    ("Rh",(Size::BYTE,  RegFamily::HIGHBYTE)),
    ("Rw",(Size::WORD,  RegFamily::LEGACY)),
